...
from nnunetv2.nets.light_mamba2net import get_light_mamba2net_from_plans
from nnunetv2.nets.light_mamba2net import get_scales
...
class nnUNetTrainerLightMamba2Net(nnUNetTrainer):
    """ LightMamba2NetP """
    ...
    def build_network_architecture(
        ...
        model = get_light_mamba2net_from_plans(
            plans_manager,
            dataset_json,
...
class nnUNetTrainerLightMamba2NetP(nnUNetTrainerLightMamba2Net):
    @staticmethod
    def build_network_architecture(
            plans_manager: PlansManager,
            dataset_json,
