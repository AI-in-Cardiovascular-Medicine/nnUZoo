...
class ExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 ...
                 suppress_transpose: bool = False, up_sample_type: str = "convtranspose"):
        """
        ...
        # The second part is for the ssl
        self.num_output_channels = len(self.dataset_json['labels'].keys()) if "labels" in self.dataset_json else len(self.dataset_json['channel_names'])
    ...
    def determine_fullres_target_spacing(self) -> np.ndarray:
        ...
        target = np.percentile(spacings, 50, axis=0) # median
    ...
    def determine_normalization_scheme_and_whether_mask_is_used_for_norm(self) -> Tuple[List[str], List[bool], List[dict]]:
    ...
    def get_plans_for_configuration(self,
        ...
        normalization_schemes, mask_is_used_for_norm, normalization_kwargs = \
