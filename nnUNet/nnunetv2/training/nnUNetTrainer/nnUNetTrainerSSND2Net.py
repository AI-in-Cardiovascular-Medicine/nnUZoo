...
try:
    from nnunetv2.nets.ssnd2net import get_ssnd2net_from_plans
except:
    pass
...
class nnUNetTrainerSSND2Net(nnUNetTrainer):
    """ Swin-UMamba """
...
class nnUNetTrainerSSND2NetP(nnUNetTrainerSSND2Net):
    @staticmethod
    def build_network_architecture(
