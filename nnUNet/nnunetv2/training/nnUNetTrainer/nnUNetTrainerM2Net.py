...
try:
    from nnunetv2.nets.m2net import get_m2net_from_plans, get_m2netp_from_plans
except:
    pass
...
class nnUNetTrainerM2Net(nnUNetTrainer):
    """ Swin-UMamba """
    ...
    def _get_deep_supervision_scales(self):
        if self.enable_deep_supervision:
            deep_supervision_scales = [[1.0, 1.0], [1.0, 1.0], [0.5, 0.5], [0.25, 0.25], [0.125, 0.125],
                                       [0.0625, 0.0625],
                                       [0.03125, 0.03125]]
        else:
...
class nnUNetTrainerM2NetP(nnUNetTrainerM2Net):
    """ Swin-UMamba """
