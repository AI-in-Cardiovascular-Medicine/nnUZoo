...
from nnunetv2.nets.u2net_multi import get_u2net_from_plans, get_u2netp_from_plans
...
class nnUNetTrainerU2NetMulti(nnUNetTrainer):
    """ Swin-UMamba """
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.spatial_dims: int = len(self.configuration_manager.patch_size)
    @staticmethod
    ...
    def _get_deep_supervision_scales(self):
        if self.enable_deep_supervision:
            if self.spatial_dims == 2:
                ...
                deep_supervision_scales = [[1.0, 1.0, 1.0]] * 7
        else:
...
class nnUNetTrainerU2NetMultiP(nnUNetTrainer):
    """ Swin-UMamba """
